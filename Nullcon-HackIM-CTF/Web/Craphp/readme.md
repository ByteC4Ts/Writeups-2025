...
The `crc16` checksum has `65536` possible values, and the `crc8` checksum has `256` possible values. `65536 * 256 = 16777216`, this is not a very large number, which allows us to brute force the result.
